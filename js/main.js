(()=> {
  /*  opens and closes the navigation menu when clicking the hamburger icon */
  ...
  /* button-tabs to navigate to each major section within individual pages */
  ...
  /*  ::after pseudo selector - adds a checkmark to input boxes once filled out */
  ...
  /* ANIMATION EFFECT ON BUTTON CLICK - TRIGGERS AN EFFECT IF THE CREDIT CARD INPUTS HAVE BEEN LEFT BLANK */
